            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        <h1 class="block py-2 text-x font-medium leading-6 text-gray-900"><strong>Add Subject</strong></h1>
                        ...
                        @csrf
                                ...
                                <div class="block mt-1">
                                    ...
                                    <select id="class_id" name="class_id" class="block mt-1 w-full sm:rounded-lg" required autofocus autocomplete="name">
                ...
                <div class="flex flex-col">
                    <div class="-m-1.5 overflow-x-auto">
                        ...
                        <div class="border rounded-lg divide-y divide-gray-200 dark:border-gray-700 dark:divide-gray-700">
                            <div class="py-3 px-4">
                            <h1 class="block py-2 text-center font-medium leading-6 text-gray-900"><strong>Subjects</strong></h1>
                            </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                @foreach($subjects as $subject)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">{{ $subject->name }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">{{ $subject->class_name }}</td>
